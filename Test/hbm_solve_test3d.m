...
[t2,x2,xdot2] = get_time_series3d(hbm,w0,sol2.X);
tRun(2) = toc;
...
[t3,x3,xdot3] = get_time_series3d(hbm,w0,sol3.X);
tRun(3) = toc;
...
[t4,x4,xdot4] = get_time_series3d(hbm,w0,sol4.X);
tRun(4) = toc;
